...
export class NoctuaActivityEntityService {
  ...
  saveActivity() {
    ...
    return self._bbopGraphService.editActivity(self.cam,
      saveData.addNodes,
      saveData.addTriples,
      saveData.removeIds);
  }
  ...
  deleteActivityNode(activity: Activity, activityNode: ActivityNode) {
    ...
    return self._bbopGraphService.deleteActivity(self.cam, deleteData.uuids, []);
  }

  deleteEvidence(uuid: string) {
    return this._bbopGraphService.deleteEvidence(this.cam, uuid);
  }


  deleteEvidenceReference(uuid: string, oldReference: string) {
    return this._bbopGraphService.deleteEvidenceAnnotation(this.cam, uuid, 'source', oldReference);
  }

  deleteEvidenceWith(uuid: string, oldWith: string) {
    return this._bbopGraphService.deleteEvidenceAnnotation(this.cam, uuid, 'with', oldWith);
  }
