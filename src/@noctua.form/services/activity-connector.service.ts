...
export class NoctuaActivityConnectorService {
  ...
  saveActivity() {
    ...
    if (self.connectorActivity.state === ConnectorState.editing) {
      ...
      return self._bbopGraphService.editConnection(
        self.cam,
      ...
      return self._bbopGraphService.addActivity(self.cam, [], saveData.triples, '', CamOperation.ADD_CAUSAL_RELATION);
    }
  }
  ...
  deleteConnectorEdge(connectorActivity: ConnectorActivity) {
    ...
    return self._bbopGraphService.deleteActivity(self.cam, [], deleteData.triples);
  }
