  ...
  saveActivity() {
    ...
    if (this.activity.activityType === ActivityType.ccOnly) {
      ...
      each(activities, (activity: Activity) => {
        ...
        promises.push(self._bbopGraphService.addActivity(self.cam, saveData.nodes, saveData.triples, saveData.title))
      })
      ...
      return forkJoin(self._bbopGraphService.addActivity(self.cam, saveData.nodes, saveData.triples, saveData.title));
    }
  }
